...
$nameErr  = $phoneErr = $emailErr = $passwordErr = $genderErr = $dobErr = $regionErr = "";
$name  = $email = $phone = $password = $gender = $dob = $region = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$nameErr && !$emailErr && !$passwordErr
        ...
        if (doesEmailAlreadyExist($email)){
            ...
            if (createUser($email, $password, $name, $phone, $region, $dob, $gender)){
                header('location: ../view/select_games.php');
            }else{
