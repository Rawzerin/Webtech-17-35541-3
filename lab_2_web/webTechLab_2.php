...
<body style="background-color:#c3e8de;"> 
<h1 style="background-color:DarkBlue;color:white;">AIUB</h1>
...
<form style="border: 3px solid black; padding: 50px; border-radius: 5px" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
